...
class spielerFigur(Figur):
    def __init__(self, x, y, groesse):
        super().__init__(x=x, y=y, groesse=groesse)
...
if __name__ == "__main__":
    # Design testen
    spieler = spielerFigur(100, 75, 200)
    herz = herzFigur(100, 200, 200)
    feuerball = feuerballFigur(100, 300, 200, 0)
    plus = plusFigur(100, 400, 200)
    pfeil = schrumpfFigur(100, 510, 200)